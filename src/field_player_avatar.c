...
u16 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_MAY_NORMAL_RS:
    case OBJ_EVENT_GFX_MAY_MACH_BIKE_RS:
    case OBJ_EVENT_GFX_MAY_ACRO_BIKE_RS:
    case OBJ_EVENT_GFX_MAY_SURFING_RS:
    case OBJ_EVENT_GFX_MAY_FIELD_MOVE_RS:
    case OBJ_EVENT_GFX_MAY_UNDERWATER_RS:
    case OBJ_EVENT_GFX_MAY_FISHING_RS:
    case OBJ_EVENT_GFX_MAY_WATERING_RS:
        return FEMALE;
    default:
        return MALE;
    }
