...
{
    [CONTEST_CATEGORY_COOL]   = OBJ_EVENT_GFX_MON_BASE+SPECIES_ZIGZAGOON,
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_MON_BASE+SPECIES_SKITTY,
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_MON_BASE+SPECIES_POOCHYENA,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_MON_BASE+SPECIES_KECLEON,
    [CONTEST_CATEGORY_TOUGH]  = OBJ_EVENT_GFX_MON_BASE+SPECIES_PIKACHU
};
