const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(ARTICUNO_GALAR, gMonShinyPalette_Articuno_Galar),
    SPECIES_SHINY_PAL(ZAPDOS_GALAR, gMonShinyPalette_Zapdos_Galar),
    SPECIES_SHINY_PAL(MOLTRES_GALAR, gMonShinyPalette_Moltres_Galar),
};
