...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_TEST]                         = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 15 },
    [SPECIES_ARTICUNO_GALAR]               = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ZAPDOS_GALAR]                 = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    [SPECIES_MOLTRES_GALAR]                = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
};
