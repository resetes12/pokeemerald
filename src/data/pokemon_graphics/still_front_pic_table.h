...
// Gen III
    ...
    SPECIES_SPRITE(VICTINI, gMonStillFrontPic_Victini),
    //SPECIES_SPRITE(UNUSED_SPACE6, gMonStillFrontPic_Unused_Space6),
    SPECIES_SPRITE(TEST, gMonStillFrontPic_Test),
    SPECIES_SPRITE(ARTICUNO_GALAR, gMonStillFrontPic_Articuno_Galar),
    SPECIES_SPRITE(ZAPDOS_GALAR, gMonStillFrontPic_Zapdos_Galar),
    SPECIES_SPRITE(MOLTRES_GALAR, gMonStillFrontPic_Moltres_Galar),
};
