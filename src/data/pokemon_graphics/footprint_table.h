const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_DEOXYS_ATTACK] = gMonFootprint_DeoxysA,
    [SPECIES_DEOXYS_DEFENSE] = gMonFootprint_DeoxysD,
    [SPECIES_DEOXYS_SPEED] = gMonFootprint_DeoxysS,
    ...
    [SPECIES_TEST] = gMonFootprint_Unown,
    [SPECIES_ARTICUNO_GALAR] = gMonFootprint_Articuno,
    [SPECIES_ZAPDOS_GALAR] = gMonFootprint_Zapdos,
    [SPECIES_MOLTRES_GALAR] = gMonFootprint_Moltres,
};
