const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(TEST, gMonBackPic_Test),
    SPECIES_SPRITE(ARTICUNO_GALAR, gMonBackPic_Articuno_Galar),
    SPECIES_SPRITE(ZAPDOS_GALAR, gMonBackPic_Zapdos_Galar),
    SPECIES_SPRITE(MOLTRES_GALAR, gMonBackPic_Moltres_Galar),
};
