const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_DEOXYS_ATTACK] =
    {
        ...
        .height = 17,
        .weight = 608,
        .description = gDeoxysAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_DEOXYS_DEFENSE] =
    {
        ...
        .height = 17,
        .weight = 608,
        .description = gDeoxysDPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_DEOXYS_SPEED] =
    {
        ...
        .height = 17,
        .weight = 608,
        .description = gDeoxysSPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_ARTICUNO_GALAR] =
    {
        ...
        .height = 17,
        .weight = 509,
        .description = gArticunoGalarPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_ZAPDOS_GALAR] =
    {
        ...
        .height = 16,
        .weight = 582,
        .description = gZapdosGalarPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 318,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_MOLTRES_GALAR] =
    {
        ...
        .height = 20,
        .weight = 660,
        .description = gMoltresGalarPokedexText,
        .pokemonScale = 270,
        .pokemonOffset = 0,
        .trainerScale = 387,
        .trainerOffset = 8,
