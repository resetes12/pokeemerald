...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_UNUSED_SPACE1] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE2] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE3] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE4] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE5] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_UNUSED_SPACE6] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_TEST]          = BACK_ANIM_SHRINK_GROW_VIBRATE,
