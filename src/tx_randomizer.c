...
static const u8 gText_Description_SimiliarEvolutionLevel[]  = _("Ensure encounters are similar\ne.g. a baby mon gets another baby mon.");
static const u8 gText_Description_IncludeLegendaries[]      = _("Include legendary pokemon.");
static const u8 gText_Description_Random_Types[]            = _("Randomize pokemon types.");
