...
const u8 gText_CantUseUntilNewBadge_Fly[] = _("This can't be used until the Fortree\nCity Badge is obtained.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge_Flash[] = _("This can't be used until the Dewford\nCity Badge is obtained.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Protein1BP[] = _("Eon Ticket{CLEAR_TO 0x64}48BP");
const u8 gText_Calcium1BP[] = _("Mystic Ticket{CLEAR_TO 0x64}96BP");
const u8 gText_Iron1BP[] = _("Aurora Ticket{CLEAR_TO 0x64}96BP");
const u8 gText_Zinc1BP[] = _("Old Sea Map{CLEAR_TO 0x64}96BP");
const u8 gText_Carbos1BP[] = _("Macho Brace{CLEAR_TO 0x64}4BP");
const u8 gText_HpUp1BP[] = _("Up Grade{CLEAR_TO 0x64}16BP");
...
//Version updater
const u8 gText_OldVersionDetected[] = _("Detected a savegame from an old\nversion.\pThe game needs to be updated.");
const u8 gText_OldVersionDetected24to35[] = _("Detected a savegame from an old\nversion.\pThe game needs to be updated.\p{COLOR RED}Modern Emerald cannot detect from\nwhich version you're updating from.\pChoose from which version are you\nupdating from.{COLOR DARK_GRAY}");
const u8 gText_Version24[] = _("v2.4 or older");
const u8 gText_Version30[] = _("v3.0/3.1/3.2");
const u8 gText_Version35[] = _("v3.3/3.4/3.5");
//Update from 2.4
const u8 gText_From24[] = _("v2.4 or older selected.\p{COLOR RED}Before proceeding, please save your\ngame in an exterior route or city\pin version 2.4.{COLOR DARK_GRAY}\pIf this is not the version you're\nupdating from, reset and start again.\pChanges won't apply until next time\nyou save the game.\pThis option will update the game to 3.2,\nthen to 3.3, and finally, apply the\platest update.\pWould you like to enable WonderTrade?");
const u8 gText_From24_WonderTrade_Yes[] = _("{COLOR BLUE}WonderTrade Enabled.{COLOR DARK_GRAY}\pWould you like to enable Unlimited\nWonderTrades? If not enabled, the\pdaily limit will be set to 3.");
const u8 gText_From24_WonderTrade_No[] = _("{COLOR BLUE}WonderTrade Disabled.{COLOR DARK_GRAY}\pWould you like to enable\nFrontier Bans?\pAccording to your current difficulty,\nenabling it will ban legendaries from\pparticipating in the Battle Frontier.\nDisabling it will let lengendaries in,\pno matter your chosen difficulty.\pWould you like to enable the bans?\n{COLOR RED}Yes{COLOR DARK_GRAY} has been always the default option.");
const u8 gText_From24_UnlimitedWT_Yes[] = _("{COLOR BLUE}Unlimited WT Enabled.{COLOR DARK_GRAY}\pWould you like to enable Frontier\nBans?\pAccording to your current difficulty,\nenabling it will ban legendaries from\pparticipating in the Battle Frontier.\nDisabling it will let lengendaries in,\pno matter your chosen difficulty.\pWould you like to enable the bans?\n{COLOR RED}Yes{COLOR DARK_GRAY} has been always the default option.");;
const u8 gText_From24_UnlimitedWT_No[] = _("{COLOR BLUE}Unlimited WT Disabled.{COLOR DARK_GRAY}\pWould you like to enable Frontier\nBans?\pAccording to your current difficulty,\nenabling it will ban legendaries from\pparticipating in the Battle Frontier.\nDisabling it will let lengendaries in,\pno matter your chosen difficulty.\pWould you like to enable the bans?\n{COLOR RED}Yes{COLOR DARK_GRAY} has been always the default option.");
const u8 gText_From24_FrontierBans_Yes[] = _("{COLOR BLUE}Frontier Bans Enabled.{COLOR DARK_GRAY}\pWould you like to enable Shiny Colors?\pThis option will let you enable the new\nShiny Colors option, which adds new\pshiny forms to certain {PKMN} species.\nPreviously, it was always {COLOR RED}On{COLOR DARK_GRAY}, now it's\poptional. Check online docs for more\ninfo and images on new shiny colors.");
const u8 gText_From24_FrontierBans_No[] = _("{COLOR BLUE}Frontier Bans Disabled.{COLOR DARK_GRAY}\pWould you like to enable Shiny Colors?\pThis option will let you enable the new\nShiny Colors option, which adds new\pshiny forms to certain {PKMN} species.\nPreviously, it was always {COLOR RED}On{COLOR DARK_GRAY}, now it's\poptional. Check online docs for more\ninfo and images on new shiny colors.");
const u8 gText_From24_ShinyColors_Yes[] = _("{COLOR BLUE}Shiny Colors Enabled.{COLOR DARK_GRAY}\pType Effectiveness Chart option\nneeds to be reset.\pGen VI Type Chart nerfs Steel not\nresisting Ghost and Dark.\pModern Type Chart buffs bad types into\nnot so bad, like Bug. Check online docs\pfor more info on this new option.\pWould you like to use Gen VI Type Chart?\pSelecting {COLOR RED}Yes{COLOR DARK_GRAY} will enable Gen VI Chart.\n{COLOR RED}No{COLOR DARK_GRAY} will set it to Modern Type Chart.");
const u8 gText_From24_ShinyColors_No[] = _("{COLOR BLUE}Shiny Colors Disabled.{COLOR DARK_GRAY}\pType Effectiveness Chart option\nneeds to be reset.\pGen VI Type Chart nerfs Steel not\nresisting Ghost and Dark.\pModern Type Chart buffs bad types into\nnot so bad, like Bug. Check online docs\pfor more info on this new option.\pWould you like to use Gen VI Type Chart?\pSelecting {COLOR RED}Yes{COLOR DARK_GRAY} will enable Gen VI Chart.\n{COLOR RED}No{COLOR DARK_GRAY} will set it to Modern Type Chart.");
const u8 gText_From24_TypeChart_Yes[] = _("{COLOR BLUE}Gen VI+ Type Effectiveness Chart\nEnabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
const u8 gText_From24_TypeChart_No[] = _("{COLOR BLUE}Modern Type Effectiveness Chart\nEnabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
//Update from 3.0
const u8 gText_From30[] = _("v3.0/3.1/3.2 selected.\pIf this is not the version you're\nupdating from, reset and start again.\pChanges won't apply until next time\nyou save the game.\pThis option will update the game to 3.3,\nand then, will apply the latest update.\pWould you like to enable WonderTrade?");
const u8 gText_From30_WonderTrade_Yes[] = _("{COLOR BLUE}WonderTrade Enabled.{COLOR DARK_GRAY}\pWould you like to enable Shiny Colors?\pThis option will let you enable the new\nShiny Colors option, which adds new\pshiny forms to certain {PKMN} species.\nPreviously, it was always {COLOR RED}On{COLOR DARK_GRAY}, now it's\poptional. Check online docs for more\ninfo and images on new shiny colors.");
const u8 gText_From30_WonderTrade_No[] = _("{COLOR BLUE}WonderTrade Disabled.{COLOR DARK_GRAY}\pWould you like to enable Shiny Colors?\pThis option will let you enable the new\nShiny Colors option, which adds new\pshiny forms to certain {PKMN} species.\nPreviously, it was always {COLOR RED}On{COLOR DARK_GRAY}, now it's\poptional. Check online docs for more\ninfo and images on new shiny colors.");
const u8 gText_From30_ShinyColors_Yes[] = _("{COLOR BLUE}Shiny Colors Enabled.{COLOR DARK_GRAY}\pType Effectiveness Chart option\nneeds to be reset.\pGen VI Type Chart nerfs Steel not\nresisting Ghost and Dark.\pModern Type Chart buffs bad types into\nnot so bad, like Bug. Check online docs\pfor more info on this new option.\pWould you like to use Gen VI Type Chart?\pSelecting {COLOR RED}Yes{COLOR DARK_GRAY} will enable Gen VI Chart.\n{COLOR RED}No{COLOR DARK_GRAY} will set it to Modern Type Chart.");
const u8 gText_From30_ShinyColors_No[] = _("{COLOR BLUE}Shiny Colors Disabled.{COLOR DARK_GRAY}\pType Effectiveness Chart option\nneeds to be reset.\pGen VI Type Chart nerfs Steel not\nresisting Ghost and Dark.\pModern Type Chart buffs bad types into\nnot so bad, like Bug. Check online docs\pfor more info on this new option.\pWould you like to use Gen VI Type Chart?\pSelecting {COLOR RED}Yes{COLOR DARK_GRAY} will enable Gen VI Chart.\n{COLOR RED}No{COLOR DARK_GRAY} will set it to Modern Type Chart.");
const u8 gText_From30_TypeChart_Yes[] = _("{COLOR BLUE}Gen VI+ Type Effectiveness Chart\nEnabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
const u8 gText_From30_TypeChart_No[] = _("{COLOR BLUE}Modern Type Effectiveness Chart\nEnabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
//Update from 3.5
const u8 gText_From35[] = _("v3.3/3.4/3.5 selected.\pIf this is not the version you're\nupdating from, reset and start again.\pChanges won't apply until next time\nyou save the game.\pThis option will update the game to\nthe latest update.\pWould you like to enable WonderTrade?");
const u8 gText_From35_WonderTrade_Yes[] = _("{COLOR BLUE}WonderTrade Enabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
const u8 gText_From35_WonderTrade_No[] = _("{COLOR BLUE}WonderTrade Disabled.{COLOR DARK_GRAY}\pThe game has been fully updated.\nSave your game to apply the update.");
