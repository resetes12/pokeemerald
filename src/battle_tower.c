...
const u8 gTowerMaleFacilityClasses[43] =
{
    ...
    FACILITY_CLASS_LEADER_TATE,
    FACILITY_CLASS_LEADER_JUAN,
...
const u8 gTowerFemaleFacilityClasses[27] =
{
...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_LEADER_MF, FACILITY_CLASS_LEADER_TATE},
